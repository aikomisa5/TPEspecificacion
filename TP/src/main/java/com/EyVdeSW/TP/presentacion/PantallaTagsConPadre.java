...
public class PantallaTagsConPadre extends VerticalLayout implements View {
	protected static final String NAME = "pantallaTagsConPadre";

	private TagConPadreService tagService = TagConPadreService.getTagService();

	Button logout = new Button("Logout");

	public PantallaTagsConPadre() {
